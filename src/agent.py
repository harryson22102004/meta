...
=======
"""
AI Agent interface for the Linux SRE Environment.

Provides:
  - AIWorker: programmatic agent that wraps TrainingEnv
  - LLMAgent: optional LLM-powered agent using LiteLLM (OpenAI/Claude/Gemini)
  - SystemPrompts: prompt templates for LLM integration
"""
